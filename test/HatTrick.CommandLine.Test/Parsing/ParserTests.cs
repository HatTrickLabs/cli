    ...
    public class ParserTests
    {
        ...
        public void Parse_WhenArgumentToken_And_Peek_IsNull_ShouldResultIn_UnflaggedOption()
        {
            Command command = Parser.Parse(new Token[] {
                ...
                new ArgumentToken("arg1"),//should pass as unflagged arg because it is 2nd and last token
            });

            Assert.IsType<UnflaggedOption>(command.Options[0]);
            Assert.Equal("UNFLAGGED", command.Options[0].Flag);
        }
