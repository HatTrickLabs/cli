...
namespace HatTrick.CommandLine.Test
{
    ...
    public class CustomArgumentConstraintTests
    {
        ...
        {
            Action action = () => new CustomArgumentConstraint<string>(null, "name", "description");
        ...
        {
            Action action = () => new CustomArgumentConstraint<int>((cmd) => true, null, "description");
        ...
        {
            Action action = () => new CustomArgumentConstraint<double>((cmd) => true, "name", null);
        ...
        {
            Action action = () => new CustomArgumentConstraint<string>((cmd) => true, string.Empty, "description");
        ...
        {
            Action action = () => new CustomArgumentConstraint<string>((cmd) => true, "name", string.Empty);
        ...
        public void Ensure_WhenConstraintFails_ShouldThrow_OptionArgumentException()
        {
            ...
            var constraint = new CustomArgumentConstraint<int>((val) => val == 5, "name", "description");
            Action action = () => constraint.Ensure(ref command.GetOptionByRef("key4"));
        ...
        public void Ensure_WhenConstraintPasses_ShouldPass()
        {
            ...
            var op4 = new Option("key4", "-4", "4");
            var command = new Command("go", op1, op2, op3, op4);
            var constraint = new CustomArgumentConstraint<int>((val) => val <= 4, "name", "description");
            constraint.Ensure(ref command.GetOptionByRef("key4"));
        }
        #endregion
        ...
        public void Usage_WhenConstraintConditionPasses_ShouldPass()
        {
            ...
            cmdDef["age"].ApplyConstraint<int>((age) => age > 7, "age restriction", "age > 7");
        ...
        [Fact]
        public void Usage_WhenConstraintConditionFails_ShouldThrow_OptionArgumentException()
        {
            DefinitionRegistry.Clear();
            var cmdDef = new CommandDefinition("go");
            cmdDef.Help = "help!";
            ...
            cmdDef["age"].ApplyConstraint<int>((age) => age > 8, "age restriction", "age > 8");
